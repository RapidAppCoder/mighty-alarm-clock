# Contributing to AlarmClock Deluxe

Thank you for your interest in contributing!

There are many ways to help improve AlarmClock Deluxe (Wecker, Uhr, Timer, Stoppuhr):
reporting issues, translating, or contributing code.

This project is a HutterSoft fork of [BlackyHawky/Clock](https://github.com/BlackyHawky/Clock).

## Reporting Issues

- Check if the issue already exists ([browse issues](https://github.com/RapidAppCoder/mighty-alarm-clock/issues)).
...
Translations for this fork are not yet hosted on a shared Weblate project.
Until that is set up, please open an issue to discuss translation contributions:
https://github.com/RapidAppCoder/mighty-alarm-clock/issues

(Upstream Clock translations live on [Codeberg Weblate](https://translate.codeberg.org/projects/clock/).)
...
- Clone the repository:
  ```bash
  git clone https://github.com/RapidAppCoder/mighty-alarm-clock.git
  cd mighty-alarm-clock
  ./gradlew build
  ```
